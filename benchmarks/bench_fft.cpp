...
BENCHMARK_TEMPLATE(BM_FFT, FFTBackend::seq)->RangeMultiplier(4)->Range(256, 1 << 18)->Complexity();
BENCHMARK_TEMPLATE(BM_FFT, FFTBackend::simd)->RangeMultiplier(4)->Range(256, 1 << 18)->Complexity();
...
BENCHMARK_TEMPLATE(BM_FFT, FFTBackend::fftw)->RangeMultiplier(4)->Range(256, 1 << 20)->Complexity();
#endif
...
BENCHMARK_TEMPLATE(BM_IFFT, FFTBackend::seq)->RangeMultiplier(4)->Range(256, 1 << 18)->Complexity();
...
BENCHMARK_TEMPLATE(BM_RFFT, FFTBackend::seq)->RangeMultiplier(4)->Range(256, 1 << 18)->Complexity();
