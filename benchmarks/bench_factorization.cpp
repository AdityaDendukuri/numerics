...
BENCHMARK_TEMPLATE(BM_LU, Backend::seq)
  ->RangeMultiplier(2)
  ->Range(64, 1024)
  ->Complexity();
BENCHMARK_TEMPLATE(BM_LU, Backend::omp)
  ->RangeMultiplier(2)
  ->Range(64, 1024)
  ->Complexity();
#if defined(NUMERICS_HAS_LAPACK)
BENCHMARK_TEMPLATE(BM_LU, Backend::lapack)
  ->RangeMultiplier(2)
  ->Range(64, 1024)
  ->Complexity();
#endif
...
#if defined(NUMERICS_HAS_LAPACK)
BENCHMARK_TEMPLATE(BM_QR, Backend::lapack)
  ->RangeMultiplier(2)
  ->Range(64, 512)
  ->Complexity();
#endif
