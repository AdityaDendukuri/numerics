/// @file fluid.cpp
/// @brief Single-switch dispatch from Backend enum to SPH backend
/// implementations.
///
...
///   2. Create apps/fluid_sim/backends/<name>/ with impl.hpp + fluid.cpp +
///   heat.cpp
...
void FluidSolver::add_particle(float x,
                               float y,
                               float vx,
                               float vy,
                               float temperature) {
...
void FluidSolver::add_body(const RigidBody& body) {
