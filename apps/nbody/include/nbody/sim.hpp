...
/// @brief Gravitational N-body simulation using num::ode_verlet / num::ode_rk4_2nd.
///
...
///
///   Verlet  (symplectic, default) -- ode_verlet:    O(h^2), bounded energy error
///   RK4     (non-symplectic)      -- ode_rk4_2nd:   O(h^4), secular energy drift
///
