...
```cpp
root_result bisection(scalar_fn f, double a, double b, double tol = 1e-8, idx max_iter = 100);
```

```cpp
auto f = [](double x) { return std::cos(x) - x; };
num::root_result r = num::bisection(f, 0.0, 1.0, 1e-12);
```
...
```cpp
root_result brent(scalar_fn f, double a, double b, double tol = 1e-8, idx max_iter = 100);
```

```cpp
num::root_result r = num::brent(f, 0.0, 1.0, 1e-12);
```
...
```cpp
root_result secant(scalar_fn f, double x0, double x1, double tol = 1e-8, idx max_iter = 100);
```

```cpp
num::root_result r = num::secant(f, 0.0, 1.0, 1e-12);
```
...
```cpp
root_result newton(scalar_fn f, scalar_fn df, double x0, double tol = 1e-8, idx max_iter = 100);
```

```cpp
auto f  = [](double x) { return x * x - 2.0; };
auto df = [](double x) { return 2.0 * x; };
num::root_result r = num::newton(f, df, 1.0, 1e-12);
```
