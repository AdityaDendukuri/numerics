...
Every routine, grouped by what it does, is in the
@ref page_kernel_index "num::kernel index". This section is the map of which header holds
what.
...
* @ref page_kernel_index "num::kernel Index" — all 88 public routines, grouped by what they do
