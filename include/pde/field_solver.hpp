...
class FieldSolver {
  public:
    ...
    static SolverResult solve_poisson(ScalarField3D &phi, const ScalarField3D &source,
                                      double tol = 1e-6, int max_iter = 500);

    /// @brief Solve \f$\nabla\cdot(c\nabla\phi)=0\f$ with Dirichlet data.
    static SolverResult solve_var_poisson(ScalarField3D &phi, const ScalarField3D &coeff,
                                          const std::vector<DirichletBC> &bcs, double tol = 1e-6,
                                          int max_iter = 500);
...
class MagneticSolver {
  public:
    ...
    static VectorField3D solve_magnetic_field(const VectorField3D &J, double tol = 1e-6,
                                              int max_iter = 500);
};

inline SolverResult FieldSolver::solve_poisson(ScalarField3D &phi, const ScalarField3D &source, double tol,
                                        int max_iter) {
...
inline SolverResult FieldSolver::solve_var_poisson(ScalarField3D &phi, const ScalarField3D &coeff,
...
inline VectorField3D MagneticSolver::current_density(const ScalarField3D &sigma,
...
inline VectorField3D MagneticSolver::solve_magnetic_field(const VectorField3D &J, double tol,
                                                   int max_iter) {
