...
RootResult bisection(ScalarFn f, real a, real b, real tol = 1e-10,
                     idx max_iter = 1000);
...
/// @param max_iter Maximum iterations
RootResult newton(ScalarFn f, ScalarFn df, real x0, real tol = 1e-10,
                  idx max_iter = 1000);
...
/// @param tol   Convergence tolerance
/// @param max_iter Maximum iterations
RootResult secant(ScalarFn f, real x0, real x1, real tol = 1e-10,
                  idx max_iter = 1000);
...
/// @param tol   Convergence tolerance
/// @param max_iter Maximum iterations
RootResult brent(ScalarFn f, real a, real b, real tol = 1e-10,
                 idx max_iter = 1000);
