...
///
/// The iteration converges for strictly diagonally dominant \f$A\f$ and can silently
/// fail to converge otherwise, so that hypothesis is required rather than described:
/// pass `num::assume_diagonally_dominant(A)`.
