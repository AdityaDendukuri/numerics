...
/// Transitional spelling for callers that still pass tolerance, iteration count,
/// and a runtime backend. The backend argument is intentionally not threaded
/// through the mathematical iteration; execution policy belongs to leaf `apply`
/// and vector-operation adapters.
template <class Op>
