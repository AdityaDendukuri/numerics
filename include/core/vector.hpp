...
///
/// Typical aliases:
///   - `num::Vector`  = BasicVector<real>    -- real-valued, full backend dispatch including GPU
///   - `num::CVector` = BasicVector<cplx>    -- complex-valued, sequential only (no GPU)
///
/// All member functions are defined inline so the template is usable across translation units
