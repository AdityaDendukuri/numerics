...
[[nodiscard]] std::vector<std::vector<cplx>> complex_copy(
...
ResolventFactor::ResolventFactor(cplx shift, const Matrix& matrix)
    : solver_(matrix) {
...
std::vector<std::vector<cplx>> resolvent_solve_rhs_batch(
  cplx shift,
  const Matrix& matrix,
...
std::vector<std::vector<std::vector<cplx>>> resolvent_solve_batch(
