...
///
/// Backend routing:
///   Backend::lapack  -> backends::lapack::eig_sym  (LAPACKE_dsyevd, divide-and-conquer)
///   Backend::omp     -> backends::omp::eig_sym     (cyclic Jacobi, parallel inner loops)
///   everything else  -> backends::seq::eig_sym     (cyclic Jacobi, sequential)
